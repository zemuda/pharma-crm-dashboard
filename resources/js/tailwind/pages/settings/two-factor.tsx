...
import TwoFactorRecoveryCodes from '@/tailwind/components/two-factor-recovery-codes';
import TwoFactorSetupModal from '@/tailwind/components/two-factor-setup-modal';
import { Badge } from '@/tailwind/components/ui/badge';
import { Button } from '@/tailwind/components/ui/button';
import { useTwoFactorAuth } from '@/tailwind/hooks/use-two-factor-auth';
